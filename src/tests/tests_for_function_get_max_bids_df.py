...
from bids import get_max_bids_df
...
class Tests(unittest.TestCase):
    ...
    def setUpClass(cls):
        ...
        cls.first_test_df = cls.sql_sc.read.csv('inputs\\inputs_for_function_get_max_bids_df\\first.txt',
                                                schema=cls.schema)
        cls.correct_first = cls.sql_sc.read.csv('inputs\\inputs_for_function_get_max_bids_df\\correct_first.txt',
                                                schema=cls.schema)
